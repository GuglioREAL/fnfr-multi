...
return graphics.newSprite(
	...
	},
	{
		...
		["spooky-kids"] = {start = 3, stop = 3, speed = 0, offsetX = 0, offsetY = 0},
		["spooky-kids losing"] = {start = 4, stop = 4, speed = 0, offsetX = 0, offsetY = 0},
		...
		["parents"] = {start = 18, stop = 18, speed = 0, offsetX = 0, offsetY = 0},
		["parents losing"] = {start = 19, stop = 19, speed = 0, offsetX = 0, offsetY = 0},
