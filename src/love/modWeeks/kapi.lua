...
return {
	...
	load = function(self)
		weeks:load()
        if song == 5 then
            inst = love.audio.newSource("music/mods/kapi/flatzone/Inst.ogg", "stream")
			voices = love.audio.newSource("music/mods/kapi/flatzone/Voices.ogg", "stream")
		elseif song == 4 then
			inst = love.audio.newSource("music/mods/kapi/nyaw/Inst.ogg", "stream")
			voices = love.audio.newSource("music/mods/kapi/nyaw/Voices.ogg", "stream")
		elseif song == 3 then
			inst = love.audio.newSource("music/mods/kapi/hairball/Inst.ogg", "stream")
			voices = love.audio.newSource("music/mods/kapi/hairball/Voices.ogg", "stream")
		elseif song == 2 then
			inst = love.audio.newSource("music/mods/kapi/beathoven/Inst.ogg", "stream")
			voices = love.audio.newSource("music/mods/kapi/beathoven/Voices.ogg", "stream")
		else
			inst = love.audio.newSource("music/mods/kapi/wocky/Inst.ogg", "stream")
			voices = love.audio.newSource("music/mods/kapi/wocky/Voices.ogg", "stream")
		end
	...
	initUI = function(self)
		weeks:initUI()
        if song == 5 then
            weeks:generateNotes(love.filesystem.load("charts/mods/kapi/flatzone" .. difficulty .. ".lua")())
		elseif song == 4 then
			weeks:generateNotes(love.filesystem.load("charts/mods/kapi/nyaw" .. difficulty .. ".lua")())
		elseif song == 3 then
			weeks:generateNotes(love.filesystem.load("charts/mods/kapi/hairball" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeks:generateNotes(love.filesystem.load("charts/mods/kapi/beathoven" .. difficulty .. ".lua")())
		else
			weeks:generateNotes(love.filesystem.load("charts/mods/kapi/wocky" .. difficulty .. ".lua")())
		end
	end,
