...
return {
	...
	load = function(self)
		...
		if song == 3 then
			inst = love.audio.newSource("music/normal/week6/thorns-inst.ogg", "stream")
			voices = love.audio.newSource("music/normal/week6/thorns-voices.ogg", "stream")
		elseif song == 2 then
			inst = love.audio.newSource("music/normal/week6/roses-inst.ogg", "stream")
			voices = love.audio.newSource("music/normal/week6/roses-voices.ogg", "stream")
		else
			inst = love.audio.newSource("music/normal/week6/senpai-inst.ogg", "stream")
			voices = love.audio.newSource("music/normal/week6/senpai-voices.ogg", "stream")
		end
	...
	initUI = function(self)
		...
		if song == 3 then
			weeksPixel:generateNotes(love.filesystem.load("charts/normal/week6/thorns" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeksPixel:generateNotes(love.filesystem.load("charts/normal/week6/roses" .. difficulty .. ".lua")())
		else
			weeksPixel:generateNotes(love.filesystem.load("charts/normal/week6/senpai" .. difficulty .. ".lua")())
		end
	end,
