...
return {
	...
	load = function(self)
		...
		inst = nil
		voices = love.audio.newSource("music/normal/tutorial/tutorial.ogg", "stream")
	...
	initUI = function(self)
		...
		weeks:generateNotes(love.filesystem.load("charts/normal/tutorial/tutorial" .. difficulty .. ".lua")())
	end,
