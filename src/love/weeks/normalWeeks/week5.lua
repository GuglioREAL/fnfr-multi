...
return {
	enter = function(self, from, songNum, songAppend)
		...
		if player2 == "default" then
			enemy = love.filesystem.load("sprites/characters/enemy/parents.lua")()
		end
		if player1 == "boyfriend" then
			boyfriend = love.filesystem.load("sprites/characters/boyfriend/boyfriend-christmas.lua")()
		...
		elseif player2 == "spooky-kids" then
			enemy.x, enemy.y = -480, 550
		elseif player2 == "daddy-dearest" then
			enemy.x, enemy.y = -480, 440
		elseif player2 == "default" or player2 == "parents" then
			enemy.x, enemy.y = -480, 410
	...
	initUI = function(self)
		...
		if song == 3 then
			weeks:generateNotes(love.filesystem.load("charts/normal/week5/winter-horrorland" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeks:generateNotes(love.filesystem.load("charts/normal/week5/eggnog" .. difficulty .. ".lua")())
		else
			weeks:generateNotes(love.filesystem.load("charts/normal/week5/cocoa" .. difficulty .. ".lua")())
		end
	end,
